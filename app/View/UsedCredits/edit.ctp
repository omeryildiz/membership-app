...
<?php echo $this->Form->create('UsedCredit'); ?>
	<fieldset>
		<legend><?php echo __('Edit Used Credit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UsedCredit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('UsedCredit.id'))); ?></li>
