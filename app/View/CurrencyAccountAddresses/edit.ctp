...
<?php echo $this->Form->create('CurrencyAccountAddress'); ?>
	<fieldset>
		<legend><?php echo __('Edit Currency Account Address'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CurrencyAccountAddress.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CurrencyAccountAddress.id'))); ?></li>
