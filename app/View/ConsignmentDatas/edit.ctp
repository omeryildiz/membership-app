...
<?php echo $this->Form->create('ConsignmentData'); ?>
	<fieldset>
		<legend><?php echo __('Edit Consignment Data'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ConsignmentData.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ConsignmentData.id'))); ?></li>
