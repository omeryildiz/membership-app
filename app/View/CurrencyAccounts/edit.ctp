<div class="currencyAccounts form">
<?php echo $this->Form->create('CurrencyAccount'); ?>
	<fieldset>
		<legend><?php echo __('Edit Currency Account'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('currency_account_code');
		echo $this->Form->input('currency_account_type');
		echo $this->Form->input('currency_account_unit');
		echo $this->Form->input('default_price');
		echo $this->Form->input('title');
		echo $this->Form->input('balance_due');
		echo $this->Form->input('remaining_receivable');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CurrencyAccount.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CurrencyAccount.id'))); ?></li>
