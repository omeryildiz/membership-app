<div class="items index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('service_or_material_code'); ?></th>
			<th><?php echo $this->Paginator->sort('service_or_material_kind'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($item['Item']['service_or_material_code']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['service_or_material_kind']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['discount']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['unit']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['pcs']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['unit_price']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['total']); ?>&nbsp;</td>
