...
<?php echo $this->Form->create('CurrencyAccountsProject'); ?>
	<fieldset>
		<legend><?php echo __('Edit Currency Accounts Project'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CurrencyAccountsProject.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CurrencyAccountsProject.id'))); ?></li>
