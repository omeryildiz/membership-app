...
<h2><?php  echo __('Orders Item'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($ordersItem['Item']['id'], array('controller' => 'items', 'action' => 'view', $ordersItem['Item']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Orders Item'), array('action' => 'delete', $ordersItem['OrdersItem']['id']), null, __('Are you sure you want to delete # %s?', $ordersItem['OrdersItem']['id'])); ?> </li>
