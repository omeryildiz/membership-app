...
<?php echo $this->Form->create('GuaranteeLetter'); ?>
	<fieldset>
		<legend><?php echo __('Edit Guarantee Letter'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GuaranteeLetter.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GuaranteeLetter.id'))); ?></li>
